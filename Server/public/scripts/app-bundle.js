...
define('modules/wall',['exports', 'aurelia-framework', 'aurelia-router', 'aurelia-auth', '../resources/data/todo', '../resources/data/users', 'moment', 'aurelia-validation'], function (exports, _aureliaFramework, _aureliaRouter, _aureliaAuth, _todo, _users, _moment, _aureliaValidation) {
  'use strict';
  ...
  var Wall = exports.Wall = (_dec = (0, _aureliaFramework.inject)(_aureliaRouter.Router, _aureliaAuth.AuthService, _todo.Todos, _users.Users), _dec(_class = function () {
    function Wall(router, auth, todos, users) {
      ...
      this.showList = true;
      this.SaveTodoError = '';
      this.datenow = (0, _moment2.default)(new Date()).format("YYYY-MM-DD");
    ...
    Wall.prototype.editTodo = function () {
    ...
    Wall.prototype.AddTodo = function () {
    ...
    Wall.prototype.listcancel = function () {
          ...
          while (1) {
            switch (_context5.prev = _context5.next) {
              case 0:
                ...
                _context5.next = 6;
                return this.todos.saveeditTodo(todo);
    ...
    Wall.prototype.toggleComplete = function () {
    ...
    Wall.prototype.toggleShowComplete = function () {
      ...
      return toggleShowComplete;
    }();

    Wall.prototype.deleteTodo = function () {
      var _ref9 = _asyncToGenerator(regeneratorRuntime.mark(function _callee9(index) {
...
define('resources/index',['exports'], function (exports) {
  ...
  function configure(config) {
    config.globalResources(['./value-converters/gravatar-url', './value-converters/date-format', './value-converters/hide-completed']);
  }
});
...
define('resources/data/todo',['exports', 'aurelia-framework', './data-services'], function (exports, _aureliaFramework, _dataServices) {
    ...
    var Todos = exports.Todos = (_dec = (0, _aureliaFramework.inject)(_dataServices.DataServices), _dec(_class = function () {
        ...
        Todos.prototype.saveeditTodo = function () {
            ...
            var _ref3 = _asyncToGenerator(regeneratorRuntime.mark(function _callee3(id) {
                ...
                return regeneratorRuntime.wrap(function _callee3$(_context3) {
                    while (1) {
                        switch (_context3.prev = _context3.next) {
                            case 0:
                                url = this.data.TODO_SERVICE + '/userTodos/' + id;
                                _context3.prev = 1;
                                _context3.next = 4;
        ...
        Todos.prototype.completedfunction = function () {
                    ...
                    while (1) {
                        switch (_context4.prev = _context4.next) {
                            case 0:
                                ...
                                _context4.prev = 1;
                                _context4.next = 4;
                                return this.data.put(todo, this.data.TODO_SERVICE + '/completed/' + id);
            ...
            function completedfunction(_x4) {
                return _ref4.apply(this, arguments);
            }
        ...
        Todos.prototype.deletetodofunction = function () {
                    ...
                    while (1) {
                        switch (_context5.prev = _context5.next) {
                            case 0:
                                ...
                                _context5.prev = 1;
                                _context5.next = 4;
                                return this.data.delete(this.data.TODO_SERVICE + '/' + id);
            ...
            function deletetodofunction(_x5) {
                return _ref5.apply(this, arguments);
            }

            return deletetodofunction;
        }();
...
define('text!modules/home.html', ['module'], function(module) { module.exports = "<template>\r\n\r\n\r\n<!-- <span class=\"glyphicon glyphicon-search\" aria-hidden=\"true\"> </span> !-->\r\n\r\n\r\n\t\r\n <!-- <div class='container'>   !-->\r\n    <div class=\"panel panel-default MarginTop\">\r\n      <div class=\"panel-body\">\r\n        <div class=\"col-lg-2\">\r\n          <h1>${message}</h1>\r\n        </div>\r\n        <div class=\"col-lg-2 pull-right\">\r\n          <img height=\"100px\" src=\"img/todo.jpg\" />\r\n        </div>\r\n      </div>\r\n    </div>\r\n\r\n\r\n\r\n\r\n <div style=\"margin-top:10px;\">\r\n\r\n    <div class=\"col-lg-1 input-group marginTop marginBottom\"> \r\n           <span show.bind=\"!showLogin\" click.trigger=\"showRegister()\" \t\tclass=\" glyphicon glyphicon-arrow-left leftMargin\">\r\n\t </span>\r\n</div> \r\n\r\n\r\n      <compose show.bind=\"showLogin\" view=\"./login.html\"></compose>\r\n      <compose show.bind=\"!showLogin\" view=\"./register.html\"></compose>\r\n      \r\n\r\n </div>\r\n<!--\r\n <div class=\"well col-md-3\">\r\n   <form id=\"form\">\r\n     <div id=\"errorMsg\" innerhtml.bind=\"loginError\"></div>\r\n     <div class=\"form-group\">\r\n !-->\r\n</template>\r\n"; });
define('text!modules/list.html', ['module'], function(module) { module.exports = "<template>\r\n\r\n\t<!--\r\n\t<div class=\"panel panel-default\" show.bind=\"users.selectedUser._id == user._id\">\r\n\t\t<div class=\"panel-body\">\r\n\t\t\t<p><textarea value.bind=\"newTodo\" class=\"form-control\" id=\"todo\" rows=\"1\" cols \"144\"> </textarea></p>\r\n\t\t\t<p><button click.trigger=\"todo()\" class=\"btn-primary\" id=\"btnTodo\">Todo</button></p>\r\n\t\t\t<div innherhtml bind=\"saveStatus\"></div>\r\n\t\t</div>\r\n\t</div>\r\n    !-->\r\n\r\n\t<div class=\"panel panel-default\">\r\n\t\t<div class=\"panel-body\">\r\n\t\t\t<div show.bind=\"wallMessage.length >0\" innerhtml.bind=\"wallMessage\"></div>\r\n\t\t\t<ul class=\"list-group\">\r\n\t\t\t\t<li class=\"list-group-item\" repeat.for=\"todo of todos.todoArray  | hideCompleted:showCompleted\">\r\n\r\n\t\t\t\t\t<!--\t\t<div clas=\"media-left\" innerhtml='${todo.todoAuthor.email | gravatarUrl:40:6}'> </div>\r\n\t\t\t\t\t<p>${todo.todoAuthor.screenName}: </p>\r\n\t\t\t\t\t\t!-->\r\n\t\t\t\t\t<div class=\"media-body\">\r\n\r\n\t\t\t\t\t\t<div class=\"col-lg-12\">\r\n\r\n\t\t\t\t\t\t\t<span class=\"col-lg-2\" click.trigger='editTodo($index)'> ${todo.todo} </span>\r\n\t\t\t\t\t\t\t<span show.bind=\"todo.completed\" class=\"col-lg-2 glyphicon glyphicon-check\" click.trigger='toggleComplete($index)'></span>\r\n\t\t\t\t\t\t\t<span show.bind=\"!todo.completed\" class=\"col-lg-2 glyphicon glyphicon-unchecked\" click.trigger='toggleComplete($index)'></span>\r\n\t\t\t\t\t\t\t<span class=\"col-lg-2\">${todo.dateDue | dateFormat}</span>\r\n\t\t\t\t\t\t\t<span class=\"col-lg-2\">${todo.priority}</span>\r\n\t\t\t\t\t\t\t<span class=\"col-lg-2 glyphicon glyphicon-remove-circle\" click.trigger='deleteTodo($index)'></span>\r\n\r\n\t\t\t\t\t\t</div>\r\n\t\t\t\t\t</div>\r\n\t\t\t\t</li>\r\n\t\t\t</ul>\r\n\t\t\t<div class=\"panel-body\">\r\n\t\t\t\t<span show.bind=\"!showCompleted\" class=\"col-lg-2 glyphicon glyphicon-check\" click.trigger='toggleShowComplete()'> Show Completed</span>\r\n\t\t\t\t<span show.bind=\"showCompleted\" class=\"col-lg-2 glyphicon glyphicon-unchecked\" click.trigger='toggleShowComplete()'> Show Completed</span>\r\n\t\t\t</div>\r\n\r\n\t\t</div>\r\n\r\n\r\n\t</div>\r\n\r\n</template>"; });
